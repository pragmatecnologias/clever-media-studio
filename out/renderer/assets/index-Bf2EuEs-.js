    ...
    (set, get) => ({
      ...
      saveCampaign: () => {
        ...
        const existingIdx = campaigns.findIndex(
          (c) => c.localId === campaign._localId
        );
        const record = {
          localId: campaign._localId || generateLocalId(),
        ...
        campaign._localId = record.localId;
        if (existingIdx >= 0) {
...
function buildCampaignSummaryDto(input) {
  ...
  const outputs = {
    ...
    exportPackage: !!input.exportResults || !!input.exportJobId
  };
  const counts = {
    slides: toNumber(deckResults.slideCount),
    socialAssets: socialAssetCount,
    captions: captionResults.length,
    exports: input.exportResults || input.exportJobId ? 1 : 0,
  ...
  return {
    ...
    deck: input.deckResults?.deckId ? {
      ...
      slides: deckSlides.map((slide, index) => ({
        ...
        status: asString(slide.status || "ready"),
        quality: {
    ...
    captions: captionResults.map((caption, index) => ({
      ...
      status: asString(caption.status || "ready")
    })),
    exports: exportResults || input.exportJobId ? [{
      exportId: asString(exportResults?.exportId || exportResults?.exportJobId || input.exportJobId || `export-${Date.now()}`),
    ...
    "div",
    {
      ...
      children: [
        ...
        hasOutputs && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2 text-[10px] text-gray-500", children: [
          ...
          socialCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "📱 ",
            socialCount
          ] }),
          captionCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "✏️ ",
            captionCount
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-600", children: timeAgo(campaign.updatedAt) }),
...
function createApiClient(baseUrl, token) {
  ...
  return {
    analyzeDocument: async (content, language, sourceType) => {
      const { data } = await client2.post("/campaigns/analyze-document", {
        content,
    ...
    createCampaign: async (campaign, analysis) => {
      const { data } = await client2.post("/campaigns", {
    ...
    updateCampaign: async (campaignId, patch) => {
      const { data } = await client2.patch(`/campaigns/${campaignId}`, patch);
      return data;
    },
    generateMediaPack: async (campaignId, options) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/generate-media-pack`, options);
      return data;
    },
    getCampaign: async (campaignId) => {
      const { data } = await client2.get(`/campaigns/${campaignId}`);
      return data;
    },
    ...
    getExportDownloadInfo: async (campaignId, exportId) => {
      const { data } = await client2.get(`/campaigns/${campaignId}/exports/${exportId}/download`);
      return data;
    },
    getCampaignSlides: async (campaignId) => {
      const { data } = await client2.get(`/campaigns/${campaignId}/slides`);
      return data;
    },
    getCampaignSocialAssets: async (campaignId) => {
      const { data } = await client2.get(`/campaigns/${campaignId}/social-assets`);
      return data;
    },
    approveSlide: async (campaignId, slideId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/slides/${slideId}/approve`);
      return data;
    },
    approveAllSlides: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/slides/approve-all`);
      return data;
    },
    regenerateSlide: async (campaignId, slideId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/slides/${slideId}/regenerate`);
      return data;
    },
    regenerateAllSlides: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/slides/regenerate`);
      return data;
    },
    approveSocialAsset: async (campaignId, assetId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/social-assets/${assetId}/approve`);
      return data;
    },
    approveAllSocialAssets: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/social-assets/approve-all`);
      return data;
    },
    regenerateSocialAsset: async (campaignId, assetId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/social-assets/${assetId}/regenerate`);
      return data;
    },
    regenerateAllSocialAssets: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/social-assets/regenerate`);
      return data;
    },
    approveCaption: async (campaignId, captionId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/captions/${captionId}/approve`);
      return data;
    },
    approveAllCaptions: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/captions/approve-all`);
      return data;
    },
    regenerateCaption: async (campaignId, captionId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/captions/${captionId}/regenerate`);
      return data;
    },
    regenerateAllCaptions: async (campaignId) => {
      const { data } = await client2.post(`/campaigns/${campaignId}/captions/regenerate`);
      return data;
    }
  };
}
function WelcomeScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto mt-12 space-y-10 px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold tracking-tight bg-gradient-to-r from-purple-400 to-amber-400 bg-clip-text text-transparent", children: "Campaign Studio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-gray-400 max-w-lg mx-auto leading-relaxed", children: "Create slides, social graphics, and captions for your sermons, events, and ministry messages." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: async () => {
              ...
              if (api?.importFile) {
                const f2 = await api.importFile();
                if (f2) {
                  resetCampaign();
                  updateCampaign({ sourceText: f2.content, sourceName: f2.name });
                  setScreen("import");
                }
              }
            },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Quick Start" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3", children: [
        ...
        "button",
        {
          onClick: () => {
            resetCampaign();
            updateCampaign({ campaignType: tpl.type, quickStart: tpl.type });
            setScreen("import");
          },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl block mb-2", children: tpl.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-200 group-hover:text-purple-300 transition-colors", children: tpl.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-500 mt-0.5 leading-snug", children: tpl.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-block mt-2 text-[10px] text-purple-400/60 group-hover:text-purple-400 transition-colors", children: [
              tpl.cta,
              " →"
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Recent Campaigns" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-600", children: [
          campaigns.length,
          " saved"
        ] })
      ] }),
      recent.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: recent.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CampaignCard,
        {
          campaign: c,
          ...
          onDelete: () => {
            if (confirm("Delete this campaign?")) deleteCampaign(c.localId);
          }
        },
        c.localId
      )) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl py-16 text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl mb-4", children: "📋" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm font-medium", children: "No campaigns yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs max-w-sm mx-auto", children: "Paste a sermon, event, devotional, or announcement to create your first media package." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs text-gray-600 pb-8 pt-4 border-t border-white/5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-2 h-2 rounded-full ${connected ? "bg-green-400" : connected === false ? "bg-red-400" : "bg-gray-600"}` }),
...
function ImportScreen() {
  ...
  const [text, setText] = reactExports.useState(campaign.sourceText);
  const [language, setLanguage] = reactExports.useState(campaign.language);
  const handleContinue = () => {
    updateCampaign({ sourceText: text, sourceName: "import.txt", language });
    setScreen("analysis");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Import Your Document" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm", children: "Paste a sermon outline, event announcement, devotional, or youth message." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: ["Sermon", "Event", "Devotional", "Youth"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
            const samples = {
...
Friday 7pm — Pizza + Games + Worship`
          ...
          className: "text-[10px] px-2 py-1 rounded bg-white/5 hover:bg-white/10 text-gray-500 hover:text-gray-300 transition-colors border border-white/5",
          children: t2
        },
        t2
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-500 uppercase tracking-wider block mb-1", children: "Language" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: language, onChange: (e) => setLanguage(e.target.value), className: "bg-gray-900 border border-white/10 rounded-lg px-3 py-2 text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("welcome"), className: "px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg text-sm border border-white/10", children: "Back" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleContinue, disabled: !text.trim(), className: "px-6 py-2 bg-purple-500 hover:bg-purple-400 disabled:bg-gray-700 disabled:text-gray-500 text-white rounded-lg text-sm font-semibold transition-all", children: "Analyze Document" })
    ] })
  ] });
}
...
function AnalysisScreen() {
  ...
  const [selectedGoal, setSelectedGoal] = reactExports.useState("");
  reactExports.useEffect(() => {
    const analyze = async () => {
      setLoading(true);
      try {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin w-8 h-8 border-2 border-purple-500 border-t-transparent rounded-full mx-auto mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: "Analyzing your document..." })
    ] });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Analysis Results" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl p-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs px-3 py-1 rounded-full border ${confColor}`, children: [
        confidencePct,
        "% · ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 uppercase tracking-wider block mb-1", children: "Campaign Type" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-200 font-medium", children: CAMPAIGN_TYPE_LABELS[selectedType] || selectedType }),
          isLowConf && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-2", children: TYPE_OPTIONS.filter((o) => o.value !== selectedType).slice(0, 4).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 uppercase tracking-wider block mb-1", children: "Goal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-200 font-medium", children: CAMPAIGN_GOAL_LABELS[selectedGoal] || selectedGoal }),
          isLowConf && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-2", children: GOAL_OPTIONS.filter((o) => o.value !== selectedGoal).slice(0, 4).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl p-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wider", children: "Extracted Message" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Title", value: campaign.title, missingText: "Add a title" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Passage / Topic", value: campaign.passageOrTopic }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Tone", value: campaign.tone }),
      ...
      result?.keyPoints?.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-white/5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: result.keyPoints.map((kp, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-300", children: [
          i + 1,
          ". ",
          kp
        ] }, i)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl p-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wider", children: [
        "Recommended for ",
      ...
      (() => {
        ...
        return bestPreset ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500", children: [
          "Suggested package: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-300", children: bestPreset.name }),
          " — ",
          bestPreset.description
        ] }) : null;
      })()
    ] }),
    (() => {
      ...
      return missing.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500/5 border border-amber-500/20 rounded-xl p-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-amber-300 uppercase tracking-wider", children: "Missing Details" }),
        missing.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-400/70 text-xs", children: [
          "• ",
          m2,
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-400/40", children: "(add in Configure)" })
        ] }, i))
      ] }) : null;
    })(),
    (() => {
      const ed2 = result?.eventDetails;
      const hasAny = ed2 && (ed2.date || ed2.time || ed2.locationName || ed2.address || ed2.website || ed2.livestreamUrl);
      return hasAny ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3", children: "Event Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
          ed2.date && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Date", value: ed2.date }),
          ed2.time && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Time", value: ed2.time }),
          ed2.locationName && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Location", value: ed2.locationName }),
          ed2.timezone && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Timezone", value: ed2.timezone }),
          ed2.address && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Address", value: ed2.address }),
          ed2.website && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Website", value: ed2.website }),
          ed2.livestreamUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(CleanField, { label: "Livestream", value: ed2.livestreamUrl })
        ] })
      ] }) : null;
    })(),
    result?.warnings?.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500/5 border border-amber-500/20 rounded-xl p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-300 text-sm font-semibold mb-2", children: "Warnings" }),
      result.warnings.map((w2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-400/70 text-xs", children: [
        "• ",
        w2
      ] }, i))
    ] }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("import"), className: "px-4 py-2 bg-white/5 rounded-lg text-sm", children: "Back" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("configure"), className: "px-6 py-2 bg-purple-500 hover:bg-purple-400 text-white rounded-lg text-sm font-semibold", children: "Continue to Configure" })
    ] })
  ] });
}
function CleanField({ label, value, missingText }) {
...
function DetailsScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Audience", value: campaign.audienceNeed, onChange: (v2) => updateCampaign({ audienceNeed: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Tone", value: campaign.tone, onChange: (v2) => updateCampaign({ tone: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "CTA", value: campaign.cta, onChange: (v2) => updateCampaign({ cta: v2 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold pt-4", children: "Event Details" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Date", value: campaign.eventDetails.date || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, date: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Time", value: campaign.eventDetails.time || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, time: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Timezone Label", value: campaign.eventDetails.timezoneLabel || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, timezoneLabel: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Location", value: campaign.eventDetails.locationName || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, locationName: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Address", value: campaign.eventDetails.address || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, address: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Website", value: campaign.eventDetails.website || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, website: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Livestream URL", value: campaign.eventDetails.livestreamUrl || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, livestreamUrl: v2 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputField$1, { label: "Phone", value: campaign.eventDetails.phone || "", onChange: (v2) => updateCampaign({ eventDetails: { ...campaign.eventDetails, phone: v2 } }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("analysis"), className: "px-4 py-2 bg-white/5 rounded-lg text-sm", children: "Back" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("style"), className: "px-6 py-2 bg-purple-500 hover:bg-purple-400 text-white rounded-lg text-sm font-semibold", children: "Choose Visual Style" })
    ] })
  ] });
}
function InputField$1({ label, value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-500 uppercase tracking-wider block", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value, onChange: (e) => onChange(e.target.value), className: "w-full bg-gray-900 border border-white/10 rounded-lg px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-purple-500/50 mt-1" })
  ] });
}
...
function StyleSelectionScreen() {
  const { setScreen, updateCampaign, campaign } = useAppStore();
  const [selected, setSelected] = React$2.useState(campaign.tone || "auto");
  const handleContinue = () => {
    updateCampaign({ tone: selected });
    setScreen("outputs");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Choose Visual Style" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm", children: "Style affects copy tone, layout, typography, image motifs, and CTA style across all generated assets." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-3", children: visualStyles.map((style) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setSelected(style.key),
        className: `text-left p-4 rounded-xl border transition-all ${selected === style.key ? "border-purple-500/40 bg-purple-500/10 shadow-lg shadow-purple-500/5" : "border-white/10 bg-white/5 hover:bg-white/8"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-4 h-4 rounded-full border-2 flex-shrink-0 ${selected === style.key ? "border-purple-400 bg-purple-500" : "border-white/20"}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: style.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: style.desc })
          ] })
        ] })
      },
      style.key
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("outputs"), className: "px-4 py-2 bg-white/5 rounded-lg text-sm", children: "Skip" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleContinue, className: "px-6 py-2 bg-purple-500 hover:bg-purple-400 text-white rounded-lg text-sm font-semibold", children: "Continue" })
    ] })
  ] });
}
const VISUAL_STYLES = [
...
function ConfigureScreen() {
  ...
  const [visualStyle, setVisualStyle] = reactExports.useState("auto");
    ...
    if (!campaign.presetId && campaign.campaignType) {
      ...
      if (bestPreset) {
        updateCampaign({
          ...
          advancedSettings: { ...campaign.advancedSettings, socialPackMode: bestPreset.socialPackMode }
        });
      }
    }
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const genResult = await api.generateMediaPack(createResult.campaignId, {
        ...
        targetSlideCount: adv.targetSlideCount !== "auto" ? Number(adv.targetSlideCount) : void 0,
        deckType: adv.deckType !== "auto" ? adv.deckType : void 0,
        branding: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Configure & Generate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-1", children: campaign.title ? campaign.title : "Review and finalize your campaign" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section$1, { title: "Campaign Details", number: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field$1, { label: "Title", value: campaign.title, onChange: (v2) => updateCampaign({ title: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field$1, { label: "Passage / Topic", value: campaign.passageOrTopic, onChange: (v2) => updateCampaign({ passageOrTopic: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field$1, { label: "Main Message", value: campaign.mainMessage, onChange: (v2) => updateCampaign({ mainMessage: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field$1, { label: "Tone", value: campaign.tone, onChange: (v2) => updateCampaign({ tone: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field$1, { label: "CTA", value: campaign.cta, onChange: (v2) => updateCampaign({ cta: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 uppercase tracking-wider block mb-1", children: "Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: TYPE_OPTIONS.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: o.value, children: o.label }, o.value))
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section$1, { title: "Visual Style", number: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: VISUAL_STYLES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-1", children: s.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-200", children: s.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 mt-0.5", children: s.desc })
        ]
      },
      s.key
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section$1, { title: "Choose Package", number: 3, children: [
        ...
        "button",
        {
          onClick: () => {
            updateCampaign({
              ...
              presetId: p2.id,
              campaignType: p2.campaignType,
              campaignGoal: p2.campaignGoal,
              advancedSettings: { ...campaign.advancedSettings, socialPackMode: p2.socialPackMode }
            });
          },
          className: `text-left p-3 rounded-lg border transition-all ${pickedPreset === p2.id ? "border-purple-500/40 bg-purple-500/10" : "border-white/10 bg-white/5 hover:bg-white/8"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-1", children: p2.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-200", children: p2.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 mt-0.5", children: p2.description })
          ]
        },
        p2.id
      )) }),
...
function Section$1({ title, number, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-white/[0.03] border border-white/5 rounded-xl p-5 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wider flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-purple-500/20 text-purple-300 text-[10px] flex items-center justify-center", children: number }),
      title
    ] }),
    children
  ] });
...
function Field$1({ label, value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 uppercase tracking-wider block mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-white/5 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `h-full rounded-full transition-all duration-700 ${failed ? "bg-red-500" : "bg-gradient-to-r from-purple-500 to-amber-500"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-gray-500", children: [
        ...
        !done && !failed && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "Poll #",
          pollCount.current,
          "/",
          MAX_POLLS
    ...
    steps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 bg-white/3 rounded-xl p-4 border border-white/5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 uppercase tracking-wider mb-3", children: "Pipeline Steps" }),
      steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm py-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-5 h-5 rounded-full flex items-center justify-center text-xs flex-shrink-0 ${step.status === "complete" ? "bg-green-500/20 text-green-400" : step.status === "running" ? "bg-purple-500/20 text-purple-400 animate-pulse" : "bg-white/5 text-gray-600"}`, children: step.status === "complete" ? "✓" : step.status === "running" ? "◉" : "○" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `flex-1 ${step.status === "pending" ? "text-gray-600" : step.status === "running" ? "text-purple-200 font-medium" : "text-gray-300"}`, children: stepLabels[step.name] || step.name })
      ] }, i))
    ] }),
    failed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-500/5 border border-red-500/20 rounded-xl p-6 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 rounded-full bg-red-500/20 flex items-center justify-center text-red-400 text-lg font-bold", children: "!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-red-300", children: "Generation Failed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-400/80", children: errorMsg })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/20 rounded-lg p-3 text-xs text-gray-500 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Backend: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-mono", children: backendUrl })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Job: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-mono", children: (campaign.generationJobId || "").slice(0, 12) })
        ] })
      ] }),
...
Time: ${(/* @__PURE__ */ new Date()).toISOString()}`;
            ...
            children: "Copy Diagnostic Info"
          }
        )
      ] })
    ] }),
    done && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-500/5 border border-green-500/20 rounded-xl p-6 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-green-500/20 flex items-center justify-center text-green-400", children: "✓" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-green-300", children: "Media pack generated successfully" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-400/80", children: "Slides, social assets, and captions are ready for review." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "Review Generated Media"
        }
      )
    ] }),
    campaign.generationJobId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-700 text-center", children: [
      "Job: ",
      campaign.generationJobId.slice(0, 8)
    ] })
  ] });
}
const tabs = [
...
function normalizeHashtags(raw) {
  return raw.split(/[\s,]+/).map((tag) => tag.trim()).filter(Boolean).map((tag) => tag.startsWith("#") ? tag : `#${tag}`);
}
function formatCount(value) {
  return value > 0 ? String(value) : "0";
}
function resolvePreset(campaign) {
  return PRESETS.find((preset) => preset.id === campaign.presetId) || PRESETS.find((preset) => preset.campaignType === campaign.campaignType && preset.campaignGoal === campaign.campaignGoal) || null;
}
...
function ReviewScreen() {
  ...
  const [screenError, setScreenError] = reactExports.useState("");
  ...
  const approveSlide = (slideId) => runAction(`slide:${slideId}`, async () => {
    if (!campaign.campaignId) return;
    await api.approveSlide(campaign.campaignId, slideId);
  });
  const regenerateSlide = (slideId) => runAction(`slide-regenerate:${slideId}`, async () => {
    if (!campaign.campaignId) return;
    await api.regenerateSlide(campaign.campaignId, slideId);
  });
  const approveSocialAsset = (assetId) => runAction(`social:${assetId}`, async () => {
    if (!campaign.campaignId) return;
    await api.approveSocialAsset(campaign.campaignId, assetId);
  });
  const regenerateSocialAsset = (assetId) => runAction(`social-regenerate:${assetId}`, async () => {
    if (!campaign.campaignId) return;
    await api.regenerateSocialAsset(campaign.campaignId, assetId);
  });
  const approveCaption = (captionId) => runAction(`caption:${captionId}`, async () => {
    if (!campaign.campaignId) return;
    await api.approveCaption(campaign.campaignId, captionId);
  });
  const regenerateCaption = (captionId) => runAction(`caption-regenerate:${captionId}`, async () => {
    if (!campaign.campaignId) return;
    await api.regenerateCaption(campaign.campaignId, captionId);
  });
  const approveAll = async (kind) => {
    if (!campaign.campaignId) return;
    const action = kind === "slides" ? api.approveAllSlides : kind === "social" ? api.approveAllSocialAssets : api.approveAllCaptions;
    await runAction(`bulk:${kind}`, async () => {
      await action(campaign.campaignId);
    });
  };
  const regenerateAll = async (kind) => {
    if (!campaign.campaignId) return;
    const action = kind === "slides" ? api.regenerateAllSlides : kind === "social" ? api.regenerateAllSocialAssets : api.regenerateAllCaptions;
    await runAction(`bulk-regenerate:${kind}`, async () => {
      await action(campaign.campaignId);
    });
  };
  const saveCaption = async (captionId) => {
    if (!campaign.campaignId) return;
  ...
  const warnings = reactExports.useMemo(() => {
    const items = [];
    const pushMessages = (category, messages) => {
      messages.filter((message) => typeof message === "string" && message.trim().length > 0).forEach((message) => {
    ...
    pushMessages("Captions", captions.flatMap((caption) => caption.warnings || []));
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold tracking-tight", children: summary.title || "Untitled Campaign" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded border ${itemStatusStyles.ready}`, children: labelCampaignStatus(summary.status) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 text-sm text-gray-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: labelCampaignType(summary.type) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: labelCampaignGoal(summary.goal) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: labelLanguage(summary.language) }),
          summary.passageOrTopic ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: summary.passageOrTopic })
          ] }) : null
        ] }),
        topError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-red-500/20 bg-red-500/5 px-3 py-2 text-sm text-red-200", children: topError }) : null
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("workspace"), className: "px-4 py-2 rounded-lg border border-white/10 bg-white/5 text-sm text-gray-300 hover:bg-white/10", children: "Workspace" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: "Export Screen"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 border-b border-white/10 pb-3", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setActiveTab(tab.id),
        className: `px-4 py-2 rounded-full text-sm border transition-colors ${activeTab === tab.id ? "bg-purple-500/15 border-purple-500/30 text-purple-100" : "bg-white/5 border-white/10 text-gray-400 hover:bg-white/10 hover:text-gray-200"}`,
        children: tab.label
      },
      tab.id
    )) }),
    activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-[1.4fr_0.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gray-500", children: "Overview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-100 mt-1", children: "Campaign summary" })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gray-500", children: "Counts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-100 mt-1", children: "Generated outputs" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-white/10 bg-black/20 p-4 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-300", children: "Quality score" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-emerald-300", children: summary.quality.score ?? "—" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono text-gray-400", children: exportJobId || "—" })
          ] })
        ] })
      ] })
    ] }),
    activeTab === "slides" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabHeader,
        {
          title: "Slides",
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveAll("slides"), busy: busyKey === "bulk:slides", label: "Approve all" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateAll("slides"), busy: busyKey === "bulk-regenerate:slides", label: "Regenerate all" })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 xl:grid-cols-2", children: slides.map((slide) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded border ${itemStatusStyles[slide.status || "draft"]}`, children: statusLabel(slide.status) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-semibold text-gray-100 mt-2", children: slide.headline || "Untitled slide" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-400", children: [
              slide.roleLabel,
              " · ",
              labelLayoutFamily(slide.layoutFamily)
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-xs text-gray-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Quality" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 text-sm", children: slide.quality?.score ?? "—" })
          ] })
        ] }),
        slide.scriptureReference ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-amber-200", children: slide.scriptureReference }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-white/10 bg-black/20 p-4 space-y-2", children: slide.bodyLines?.length ? slide.bodyLines.map((line, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-300", children: line }, `${slide.id}-${index}`)) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "No body copy." }) }),
        slide.quality?.warnings?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: slide.quality.warnings.map((warning, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-300", children: warning }, `${slide.id}-warning-${index}`)) }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("slidePreview"), className: "px-3 py-2 rounded-lg border border-white/10 bg-white/5 text-xs text-gray-300 hover:bg-white/10", children: "Preview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateSlide(slide.id), busy: busyKey === `slide-regenerate:${slide.id}`, label: "Regenerate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveSlide(slide.id), busy: busyKey === `slide:${slide.id}`, label: "Approve" })
        ] })
      ] }, slide.id)) })
    ] }),
    activeTab === "social" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabHeader,
        {
          title: "Social pack",
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveAll("social"), busy: busyKey === "bulk:social", label: "Approve all" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateAll("social"), busy: busyKey === "bulk-regenerate:social", label: "Regenerate all" })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 xl:grid-cols-2", children: socialAssets.map((asset) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: labelSocialPlatform(asset.platform) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded border ${itemStatusStyles[asset.status || "draft"]}`, children: statusLabel(asset.status) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-semibold text-gray-100 mt-2", children: asset.roleLabel || labelSocialAssetRole(asset.role) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-400", children: [
              asset.width,
              " x ",
              asset.height,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-xs text-gray-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Quality" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 text-sm", children: asset.quality?.score ?? "—" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-white/10 bg-black/20 p-4 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-200", children: asset.caption || "No caption text." }),
          asset.cta ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-purple-200", children: [
            "CTA: ",
            asset.cta
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("socialPreview"), className: "px-3 py-2 rounded-lg border border-white/10 bg-white/5 text-xs text-gray-300 hover:bg-white/10", children: "Open Preview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateSocialAsset(asset.id), busy: busyKey === `social-regenerate:${asset.id}`, label: "Regenerate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveSocialAsset(asset.id), busy: busyKey === `social:${asset.id}`, label: "Approve" })
        ] })
      ] }, asset.id)) })
    ] }),
    activeTab === "captions" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabHeader,
        {
          title: "Captions",
          ...
          actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveAll("captions"), busy: busyKey === "bulk:captions", label: "Approve all" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateAll("captions"), busy: busyKey === "bulk-regenerate:captions", label: "Regenerate all" })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: captions.map((caption) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400", children: [
                  labelSocialAssetRole(caption.role),
                  " · ",
                  labelSocialPlatform(caption.platform)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded border ${itemStatusStyles[caption.status || "draft"]}`, children: statusLabel(caption.status) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-semibold text-gray-100 mt-2", children: caption.cta || "Caption copy" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap justify-end", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => regenerateCaption(caption.id), busy: busyKey === `caption-regenerate:${caption.id}`, label: "Regenerate" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ActionButton, { onClick: () => approveCaption(caption.id), busy: busyKey === `caption:${caption.id}`, label: "Approve" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => {
          ...
          isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.25em] text-gray-500", children: "Caption text" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  value: draft.caption,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.25em] text-gray-500", children: "CTA" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: draft.cta,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.25em] text-gray-500", children: "Hashtags" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-white/10 bg-black/20 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-200 whitespace-pre-wrap", children: caption.caption || "No caption text." }) }),
            caption.hashtags?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: caption.hashtags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 rounded-full bg-purple-500/10 text-xs text-purple-200 border border-purple-500/20", children: tag }, `${caption.id}-${tag}`)) }) : null
          ] })
        ] }, caption.id);
      }) })
    ] }),
    activeTab === "exports" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-4 lg:grid-cols-[1.1fr_0.9fr]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gray-500", children: "Latest export" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setScreen("export"),
              className: "px-4 py-2 rounded-lg border border-white/10 bg-white/5 text-sm text-gray-300 hover:bg-white/10",
              children: "Open export screen"
            }
          )
        ] })
      ] })
    ] }),
    activeTab === "warnings" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabHeader, { title: "Warnings", subtitle: `${warnings.length} issue${warnings.length === 1 ? "" : "s"} across summary, media, and export flow` }),
      warnings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5 text-emerald-200", children: "No warnings. The current review set is clean." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: warnings.map((warning, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-2xl border p-4 ${severityStyles[warning.severity]}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.25em] opacity-80", children: warning.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: warning.message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-2 py-0.5 rounded-full border border-current/20", children: warning.severity })
      ] }) }, `${warning.category}-${index}`)) })
    ] })
  ] });
}
function TabHeader(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gray-500", children: props.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-100 mt-1", children: props.subtitle })
    ] }),
...
function MetricCard({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-white/10 bg-black/20 p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.25em] text-gray-500", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-2xl font-semibold text-gray-100 break-words", children: value })
  ] });
}
function InfoRow({ label, value, monospace }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: monospace ? "font-mono text-xs text-gray-300 text-right break-all" : "text-gray-200 text-right break-words", children: value })
  ] });
}
...
function getLayoutStyle(purpose, layoutFamily) {
...
function SlideCanvas({ slide, totalSlides }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: { minHeight: 420 },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 w-full h-0.5", style: { background: `linear-gradient(90deg, transparent, ${style.accent}, transparent)` } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-6 right-8 w-24 h-24 rounded-full opacity-[0.04]", style: { background: style.accent } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-8 w-32 h-32 rounded-full opacity-[0.03]", style: { background: style.accent } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-5 right-7 text-[11px] opacity-25 z-10", style: { color: style.subtext }, children: [
          slide.index,
          " / ",
          totalSlides || 8
        ] }),
        isTitle && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-12 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 w-20 h-0.5 rounded-full opacity-50", style: { background: style.accent } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight max-w-lg", style: { color: style.text }, children: slide.headline }),
          slide.passageOrTopic && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-px opacity-40", style: { background: style.accent } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium tracking-wide opacity-70", style: { color: style.accent }, children: slide.passageOrTopic }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-px opacity-40", style: { background: style.accent } })
          ] }),
          slide.subheadline && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base opacity-45 mt-4 italic max-w-md", style: { color: style.subtext }, children: slide.subheadline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 w-20 h-0.5 rounded-full opacity-40", style: { background: style.accent } })
        ] }),
        isScripture && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-16 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-7xl leading-none opacity-[0.12] mb-3", style: { color: style.accent }, children: "“" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-bold italic leading-relaxed max-w-xl", style: { color: style.text }, children: slide.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-px mx-auto my-5 opacity-25", style: { background: style.accent } }),
          slide.bodyLines?.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base leading-relaxed opacity-60 max-w-lg", style: { color: style.subtext }, children: line }, i))
        ] }),
        isContext && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-16 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] opacity-40 mb-6", style: { color: style.subtext }, children: "The Big Idea" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl lg:text-4xl font-bold leading-snug max-w-lg", style: { color: style.text }, children: slide.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 mx-auto mt-6 rounded-full opacity-40", style: { background: style.accent } }),
          slide.bodyLines?.slice(0, 2).map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm opacity-50 mt-3 max-w-md", style: { color: style.subtext }, children: line }, i))
        ] }),
        isPoint && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col justify-center px-16 py-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-bold opacity-15 flex-shrink-0", style: { color: style.accent }, children: slide.index - 2 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-bold leading-snug", style: { color: style.text }, children: slide.headline })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px opacity-15 mb-4", style: { background: style.accent } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-16 space-y-2", children: slide.bodyLines?.slice(0, 3).map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed opacity-55", style: { color: style.subtext }, children: line }, i)) })
        ] }),
        isApplication && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col justify-center px-16 py-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.2em] opacity-40 mb-3", style: { color: style.subtext }, children: "Living It Out" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-bold leading-snug mb-5", style: { color: style.text }, children: slide.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: slide.bodyLines?.slice(0, 4).map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 opacity-50", style: { background: style.accent } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed opacity-60", style: { color: style.subtext }, children: line })
          ] }, i)) })
        ] }),
        isReflection && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-16 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl opacity-[0.1] mb-4", style: { color: style.accent }, children: "?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-bold leading-relaxed max-w-lg", style: { color: style.text }, children: slide.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-0.5 mx-auto my-4 rounded-full opacity-30", style: { background: style.accent } }),
          slide.bodyLines?.slice(0, 2).map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm opacity-45 mt-2 italic max-w-md", style: { color: style.subtext }, children: line }, i))
        ] }),
        isInvitation && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-16 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.2em] opacity-40 mb-5", style: { color: style.subtext }, children: "You Are Invited" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 mx-auto my-5 rounded-full opacity-40", style: { background: style.accent } }),
          slide.bodyLines?.slice(0, 3).map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm leading-relaxed max-w-md ${i === 0 ? "opacity-60 font-medium" : "opacity-45"}`, style: { color: i === 0 ? style.text : style.subtext }, children: line }, i))
        ] }),
        isClosing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-16 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-0.5 mx-auto mb-5 rounded-full opacity-30", style: { background: style.accent } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-bold leading-relaxed max-w-lg", style: { color: style.text }, children: slide.headline }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-full h-16 opacity-[0.04]", style: {
...
function SlidePreviewScreen() {
  const { setScreen, campaign, backendUrl } = useAppStore();
  const [selectedIndex, setSelectedIndex] = reactExports.useState(0);
  const [slideData, setSlideData] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (!campaign.campaignId) return;
    const api = createApiClient(backendUrl);
  ...
  const slides = React$2.useMemo(() => {
    if (rawSlides.length > 0) {
      ...
      return rawSlides.map((s) => ({
        ...
        passageOrTopic: s.purpose === "title" ? passage : void 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Slide Preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-1", children: slides.length > 0 ? `${slides.length} slides · ${new Set(slides.map((s) => s.layoutFamily)).size} layout families` : "Fetching slide data..." })
      ] }),
      slides.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-green-500/10 text-green-400 px-2 py-1 rounded border border-green-500/20 uppercase tracking-wider", children: "Generated" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-52 flex-shrink-0 space-y-1.5 max-h-[500px] overflow-y-auto pr-1", children: [
        slides.map((slide, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `w-full text-left p-2.5 rounded-lg text-xs border transition-all ${i === selectedIndex ? "border-purple-500/40 bg-purple-500/10" : "border-white/5 bg-white/5 hover:bg-white/8"}`,
        ...
        slides.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-xs text-center py-12", children: [
          "No slides generated yet.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Enable Presentation Deck in Outputs."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-4", children: selected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SlideCanvas, { slide: selected, totalSlides: slides.length }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-3 text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 font-medium truncate", children: selected.visualIntent })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 uppercase tracking-wider mb-0.5", children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 rounded bg-purple-500/10 text-purple-300", children: "Draft" })
          ] })
        ] }),
        quality && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-4 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 uppercase tracking-wider", children: "Quality Overview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded font-medium ${quality.passed ? "bg-green-500/10 text-green-400" : "bg-amber-500/10 text-amber-400"}`, children: quality.passed ? "Usable" : "Needs Review" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Content" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-200", children: [
                quality.contentScore ?? Math.round(quality.score * 0.85),
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Readability" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-200", children: [
                quality.readabilityScore ?? Math.round(quality.score * 0.88),
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Design" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: quality.designScore && quality.designScore < 65 ? "text-amber-400" : "text-gray-200", children: [
                quality.designScore ?? Math.round(quality.score * 0.55),
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Ministry Use" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-200", children: [
                quality.ministryScore ?? Math.round(quality.score * 0.8),
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "Export Ready" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-400 font-medium", children: [
                quality.exportScore ?? quality.score,
                "/100"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-t border-white/5 pt-1 mt-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 font-semibold", children: "Overall" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-200 font-semibold", children: [
                quality.score,
                "/100"
              ] })
            ] })
          ] }),
          quality.warnings?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1 space-y-0.5", children: quality.warnings.slice(0, 3).map((w2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-amber-400/60", children: [
            "• ",
            w2
          ] }, i)) })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video bg-gray-900 border border-white/10 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-lg", children: "Select a slide to preview" }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("review"), className: "px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg text-sm text-gray-300 transition-all", children: "Back to Review" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("review"), className: "px-6 py-2.5 bg-purple-500 hover:bg-purple-400 text-white rounded-lg text-sm font-semibold transition-all shadow-lg shadow-purple-500/20", children: "Approve All Slides" })
    ] })
  ] });
}
const platformMeta = {
...
function buildAssetDataFromCampaign(campaign, apiAssets) {
  ...
  const backendSpecs = socialResults?.assetSpecs || campaign.socialPackPlan?.assets || [];
  const allSpecs = backendSpecs.length > 0 ? backendSpecs.map((s) => ({
  ...
  const apiAssetMap = /* @__PURE__ */ new Map();
  if (apiAssets) {
    apiAssets.forEach((a) => apiAssetMap.set(a.id, a));
  }
  if (captionResults.length > 0) {
    return captionResults.map((caption, i) => {
...
function AssetCard({ asset }) {
  ...
  const statusLabel2 = asset.status === "ready" ? "Ready" : asset.status === "generating" ? "Regenerating" : asset.status === "failed" ? "Failed" : "Draft";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-xl overflow-hidden transition-all hover:border-white/20 hover:bg-white/8 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `relative bg-gradient-to-br ${meta.bg} overflow-hidden flex items-center justify-center`,
        style: isStory ? { aspectRatio: "9/16", maxHeight: 480, minHeight: 360 } : { aspectRatio: `${asset.width}/${asset.height}`, maxHeight: isVertical ? 380 : 240 },
        children: [
          asset.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl opacity-15 mb-3", children: meta.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs opacity-25", style: { color: meta.color }, children: [
              asset.width,
              "×",
              asset.height
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-semibold z-10",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3 px-2 py-0.5 rounded text-[9px] bg-black/60 text-white uppercase tracking-wider z-10", children: asset.format })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2 flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-gray-200 capitalize", children: labelSocialAssetRole(asset.role) || humanize(asset.role) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-1.5 py-0.5 rounded font-medium ${asset.status === "ready" ? "bg-green-500/10 text-green-400" : asset.status === "failed" ? "bg-red-500/10 text-red-400" : asset.status === "generating" ? "bg-amber-500/10 text-amber-300" : "bg-white/5 text-gray-500"}`, children: statusLabel2 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-300 line-clamp-2", children: asset.headline }),
      asset.cta && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[10px] px-2 py-0.5 rounded-full text-purple-300 bg-purple-500/10 w-fit", children: asset.cta }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 pt-2 mt-auto border-t border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleCopyCaption,
            disabled: !asset.caption,
            ...
            title: "Copy caption",
            children: copied ? "Copied!" : "Copy Caption"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: "text-[10px] px-2 py-1 rounded bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 hover:text-purple-200 transition-colors font-medium",
            title: "Approve this asset",
            children: "Approve"
          }
        )
      ] }),
      showDetails && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-1 border-t border-white/5 text-[10px]", children: [
        asset.caption && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Caption: " }),
          asset.caption.slice(0, 200)
        ] }),
...
function SocialPackPreviewScreen() {
  const { setScreen, campaign, backendUrl } = useAppStore();
  ...
  reactExports.useEffect(() => {
    ...
    const api = createApiClient(backendUrl);
    api.getCampaignSocialAssets(campaign.campaignId).then(setSocialData).catch(() => {
    });
  }, [campaign.campaignId, hasSocial, backendUrl]);
  const apiAssets = socialData?.assets || [];
  ...
  const mode = socialResults?.mode || socialData?.mode || "devotional_pack";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `px-3 py-1.5 rounded-lg text-xs transition-all font-medium ${activeTab === "all" ? "bg-purple-500/20 text-purple-200 border border-purple-400/40" : "bg-white/5 text-gray-400 border border-white/10 hover:bg-white/8"}`,
          children: [
            "All (",
            assets.length,
            ")"
      ...
      platforms.map((p2) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `px-3 py-1.5 rounded-lg text-xs transition-all capitalize ${activeTab === p2 ? "border text-white" : "bg-white/5 text-gray-400 border border-white/10 hover:bg-white/8"}`,
            style: activeTab === p2 ? { background: m2.color + "22", borderColor: m2.color + "44" } : {},
            children: [
              m2.label,
              " (",
              assets.filter((a) => a.platform === p2).length,
              ")"
            ]
          },
          p2
    ...
    filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-3 gap-4", children: filtered.map((asset) => /* @__PURE__ */ jsxRuntimeExports.jsx(AssetCard, { asset }, asset.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/5 border border-white/10 rounded-xl flex items-center justify-center py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: assets.length === 0 ? "No social assets generated. Enable Social Pack in Outputs." : "No assets match this filter." }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function SettingsScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto mt-8 space-y-8 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: "Settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Backend Connection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Default Language" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          value: appSettings.defaultLanguage,
          onChange: (e) => updateAppSettings({ defaultLanguage: e.target.value }),
          className: "w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-gray-300",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "en", children: "English" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Data Management" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          onClick: () => {
            if (confirm("Delete all campaign history? This cannot be undone.")) clearCampaignHistory();
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-2 pt-4 border-t border-white/5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "Clever Campaign Studio v1.0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "Backend: clever-slides-backend" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
...
function TopBar() {
  ...
  const statusLabel2 = STATUS_LABELS[status] || status;
  const statusColor = STATUS_COLORS[status] || STATUS_COLORS.draft;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-3 border-b border-white/5 bg-gray-900/50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-200 truncate max-w-md", children: campaign.title || "Untitled Campaign" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] px-2 py-0.5 rounded border ${statusColor}`, children: statusLabel2 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-3 py-1.5 rounded-lg text-xs transition-all ${drawerOpen ? "bg-purple-500/20 text-purple-200" : "bg-white/5 text-gray-400 hover:bg-white/10"}`,
          children: "⚙ Advanced"
        }
      )
    ] })
...
function SidebarItem({ icon, label, active, badge, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      onClick,
      className: `w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs transition-all text-left ${active ? "bg-purple-500/15 text-purple-200 border border-purple-500/30" : "text-gray-400 hover:text-gray-200 hover:bg-white/5 border border-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm w-5 text-center", children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: label }),
        badge !== void 0 && badge !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded-full leading-none", children: badge })
      ]
    }
  );
}
...
function SettingsDrawer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/40 z-20", onClick: toggleDrawer }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed right-0 top-0 bottom-0 w-96 bg-gray-900 border-l border-white/10 z-30 overflow-y-auto shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 bg-gray-900 border-b border-white/10 p-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Advanced Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: toggleDrawer, className: "text-gray-500 hover:text-gray-300 text-lg", children: "✕" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Campaign Strategy", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectField,
            {
              label: "Type",
              value: campaign.campaignType,
              onChange: (v2) => updateCampaign({ campaignType: v2 }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectField,
            {
              ...
              onChange: (v2) => updateCampaign({ campaignGoal: v2 }),
              options: GOAL_OPTIONS.map((o) => ({ value: o.value, label: o.label }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "Tone", value: campaign.tone, onChange: (v2) => updateCampaign({ tone: v2 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "CTA", value: campaign.cta, onChange: (v2) => updateCampaign({ cta: v2 }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Deck Settings", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectField,
            {
              label: "Deck Type",
              value: adv.deckType,
              onChange: (v2) => update({ deckType: v2 }),
              options: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              label: "Slide Count",
              value: String(adv.targetSlideCount),
              onChange: (v2) => update({ targetSlideCount: v2 === "auto" ? "auto" : Number(v2) }),
              options: [
                { value: "auto", label: "Auto" },
                { value: "6", label: "6" },
                { value: "8", label: "8" },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Show Logo", checked: adv.showLogo, onChange: () => update({ showLogo: !adv.showLogo }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Show Address", checked: adv.showAddress, onChange: () => update({ showAddress: !adv.showAddress }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Show Website", checked: adv.showWebsite, onChange: () => update({ showWebsite: !adv.showWebsite }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Show Phone", checked: adv.showPhone, onChange: () => update({ showPhone: !adv.showPhone }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Show Service Time", checked: adv.showServiceTime, onChange: () => update({ showServiceTime: !adv.showServiceTime }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Social Pack", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectField,
            {
              label: "Mode",
              value: adv.socialPackMode,
              onChange: (v2) => update({ socialPackMode: v2 }),
              options: Object.entries(SOCIAL_MODE_LABELS).map(([v2, l2]) => ({ value: v2, label: l2 }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CheckboxGroup,
            {
              label: "Platforms",
              selected: adv.platforms,
              options: ["instagram", "facebook", "whatsapp", "youtube", "x"],
              onChange: (v2) => update({ platforms: v2 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Image Settings", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectField,
            {
              label: "Provider",
              value: adv.imageProvider,
              onChange: (v2) => update({ imageProvider: v2 }),
              options: [
                { value: "auto", label: "Auto" },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              label: "Visual Style",
              value: adv.visualStyle,
              onChange: (v2) => update({ visualStyle: v2 }),
              placeholder: "auto"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Export", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CheckboxGroup,
            {
              label: "Formats",
              selected: adv.exportFormats,
              options: ["pptx", "pdf", "png", "jpg", "json", "txt", "md", "zip"],
              onChange: (v2) => update({ exportFormats: v2 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Include Source", checked: adv.includeSource, onChange: () => update({ includeSource: !adv.includeSource }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { label: "Include Metadata", checked: adv.includeMetadata, onChange: () => update({ includeMetadata: !adv.includeMetadata }) })
        ] })
      ] })
    ] })
  ] });
...
function Section({ title, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "group", open: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wider cursor-pointer hover:text-gray-300 mb-2", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 pl-1", children })
  ] });
}
function InputField({ label, value, onChange, placeholder }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 block mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        value,
...
function ToggleRow({ label, checked, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center justify-between py-0.5 cursor-pointer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onChange,
        className: `w-7 h-4 rounded-full transition-colors relative ${checked ? "bg-purple-500" : "bg-white/20"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all ${checked ? "left-3.5" : "left-0.5"}` })
      }
    )
  ] });
}
function CheckboxGroup({ label, selected, options, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 block mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => toggle(opt),
        className: `text-[10px] px-2 py-0.5 rounded capitalize transition-colors ${selected.includes(opt) ? "bg-purple-500/20 text-purple-200 border border-purple-400/40" : "bg-white/5 text-gray-500 border border-white/10"}`,
        children: opt
      },
      opt
    )) })
...
function SummaryPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    campaign.mainMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-300", children: campaign.mainMessage.slice(0, 300) })
    ] })
  ] });
}
function InfoCard({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 uppercase tracking-wider mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-200 truncate", children: value })
  ] });
}
function StatCard({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 border border-white/10 rounded-lg p-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-purple-300", children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 uppercase tracking-wider", children: label })
  ] });
}
function SourcePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Source Text" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/5 border border-white/10 rounded-lg p-4 max-h-96 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs text-gray-400 whitespace-pre-wrap font-sans", children: campaign.sourceText }) })
  ] });
}
function ConfigurePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 max-w-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Configure Campaign" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Title", value: campaign.title, onChange: (v2) => updateCampaign({ title: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Passage / Topic", value: campaign.passageOrTopic, onChange: (v2) => updateCampaign({ passageOrTopic: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Main Message", value: campaign.mainMessage, onChange: (v2) => updateCampaign({ mainMessage: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tone", value: campaign.tone, onChange: (v2) => updateCampaign({ tone: v2 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "CTA", value: campaign.cta, onChange: (v2) => updateCampaign({ cta: v2 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Toggle,
          {
            checked: campaign.outputSelections.presentationDeck,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Slides" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Toggle,
          {
            checked: campaign.outputSelections.socialPack,
            onChange: () => updateCampaign({ outputSelections: { ...campaign.outputSelections, socialPack: !campaign.outputSelections.socialPack } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Social" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Toggle,
          {
            checked: campaign.outputSelections.captionPack,
            onChange: () => updateCampaign({ outputSelections: { ...campaign.outputSelections, captionPack: !campaign.outputSelections.captionPack } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Captions" })
      ] })
    ] })
  ] });
}
function Field({ label, value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-gray-500 uppercase tracking-wider block mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        value,
...
function Toggle({ checked, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all ${checked ? "left-4" : "left-0.5"}` })
    }
  );
}
function WarningsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Warnings" }),
    allWarnings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "No warnings" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: allWarnings.map((w2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500/5 border border-amber-500/20 rounded-lg p-3 flex items-start gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-400 mt-0.5", children: "⚠" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-amber-500/70 uppercase block", children: w2.cat }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-300", children: w2.msg })
      ] })
    ] }, i)) })
  ] });
}
function WorkspaceLayout() {
  ...
  const renderPanel = () => {
    switch (workspaceTab) {
      case "summary":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryPanel, {});
      case "source":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SourcePanel, {});
      case "configure":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigurePanel, {});
      case "slides":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SlidePreviewScreen, {});
      case "social":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SocialPackPreviewScreen, {});
      case "captions":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CaptionsPanel, {});
      case "exports":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ExportScreen, {});
      case "warnings":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WarningsPanel, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryPanel, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-[calc(100vh-57px)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto p-6", children: renderPanel() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsDrawer, {})
  ] });
}
...
function App() {
  ...
  const renderScreen = () => {
    switch (screen) {
      case "welcome":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeScreen, {});
      case "import":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ImportScreen, {});
      case "analysis":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AnalysisScreen, {});
      case "details":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DetailsScreen, {});
      case "style":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(StyleSelectionScreen, {});
      case "outputs":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigureScreen, {});
      case "configure":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigureScreen, {});
      case "generating":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(GeneratingScreen, {});
      case "review":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewScreen, {});
      case "slidePreview":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SlidePreviewScreen, {});
      case "socialPreview":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SocialPackPreviewScreen, {});
      ...
      case "workspace":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WorkspaceLayout, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeScreen, {});
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 text-gray-100 font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-white/5 bg-gray-900/50 backdrop-blur px-6 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: "Clever Campaign Studio"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 bg-white/5 px-2 py-0.5 rounded", children: "v1.0" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs text-gray-400", children: [
        campaign.title && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300", children: campaign.title }),
        campaign.title && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: screenTitles[screen] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => {
    ...
    isInFlow && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-2 border-b border-white/5 bg-gray-900/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 text-xs", children: FLOW_LABELS.map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React$2.Fragment, { children: [
      i > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "→" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `px-2 py-0.5 rounded-full ${i === flowStep ? "bg-purple-500/20 text-purple-200 font-medium" : i < flowStep ? "text-gray-500" : "text-gray-700"}`, children: [
        i < flowStep ? "✓" : "",
        " ",
        label
      ] })
    ] }, label)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: isInFlow ? "p-6" : "", children: renderScreen() })
  ] });
}
